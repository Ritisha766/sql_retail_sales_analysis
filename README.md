...
- **Database Creation**: The project starts by creating a database named `SQLPROJECTP1`.
...
FROM
(SELECT YEAR(sale_date) AS SALE_YEAR,MONTH(sale_date) AS BESTSELLING_MONTH,
